...
### Fixed
- Driver 550+ now enables pause/resume (previously required 580+)
- Driver 580+ still required for full migration to different GPU
- Improved error message to clarify driver requirements
